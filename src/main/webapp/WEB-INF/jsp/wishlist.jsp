    ...
    <div class="grid grid-cols-1 gap-6">
        <% if(!wishlistItems.isEmpty()){
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <div class="relative">
                    <img src="<%=FirebaseStorageUtil.generateSignedUrl(product.getImages().get(0).getImageUrl())%>" alt="<%=product.getName()%>>" class="w-full">
                ...
                <div class="p-4">
                    ...
                    <p class="text-gray-500">$<%=product.getPrice()%></p>
                    <p class="text-gray-400"><%=product.getDescription()%></p>
                    ...
                    <a href="/product/detail?productId<%=product.getId()%>" class="mt-4 w-full bg-gray-800 text-white py-2 rounded-md flex items-center justify-center">

...
<div class="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md mt-10">
    <h1 class="text-3xl font-bold mb-8 text-gray-900">Add New Product</h1>
    ...
    <form action="/controller/add-product" method="post" enctype="multipart/form-data" class="space-y-6">
        ...
        <div>
            <label for="quantityAvailable" class="block text-lg text-gray-700 font-medium mb-2">Quantity Available</label>
        ...
        <div>
            <label for="availableProductSizes" class="block text-lg text-gray-700 font-medium mb-2">Available Product Sizes</label>
        ...
        <div class="text-right">
            <button type="submit" class="bg-blue-600 text-white px-6 py-3 rounded-lg hover:bg-blue-700 transition duration-200 font-semibold">Add Product</button>
        </div>
    </form>
</div>
